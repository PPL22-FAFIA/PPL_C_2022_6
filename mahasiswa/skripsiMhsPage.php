        ...
        <div class="card ms-2 me-2">
            ...
            <form class="card-body">
                ...
                <div class="col-11 mt-3 mb-3">
                    ...
                    <select class="ms-4 form-select" id="statusskripsi" name="statusskripsi" aria-label="Status Skripsi" onchange="hideNilai(this.value)">
                ...
                <div id="divskripsi">
                    <div class="col-11 mb-3" id="divnilai">
                        <?php if ($statusskripsi->Status == "Sudah Ambil"){
                            echo '<label for="nilai" class="fs-5 ms-4 fw-bold form-label">Nilai</label>
                    <!-- select option A-E -->
                    <select class="ms-4 form-select" id="nilai" name="nilai" aria-label="Nilai Skripsi" required>
                    <option value="A"'; if ($statusskripsi->Nilai == "A") echo "selected"; echo '>A</option>
                    <option value="B"'; if ($statusskripsi->Nilai == "B") echo "selected"; echo '>B</option>
                    <option value="C" '; if ($statusskripsi->Nilai == "C") echo "selected"; echo '>C</option>
                    <option value="D" '; if ($statusskripsi->Nilai == "D") echo "selected"; echo '>D</option>
                    <option value="E" '; if ($statusskripsi->Nilai == "E") echo "selected"; echo '>E</option>
                    </select>';
                        }?>
                    </div>
